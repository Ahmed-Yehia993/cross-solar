...
import com.crossover.techtrial.Validator.PanelValidator;
...
public class PanelController {
    ...
    public ResponseEntity<?> registerPanel(@RequestBody Panel panel) {
        if (!panelValidator.validate(panel)) {
    ...
    public ResponseEntity<List<DailyElectricity>> allDailyElectricityFromYesterday(
        ...
        dailyElectricityForPanel = hourlyElectricityService.getDailyStatistics(panelSerial);
